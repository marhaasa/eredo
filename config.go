...
// override, the repo's own .eredo/allowlist.txt. Only domain-shaped lines
...
func allowlistDir(name, primary string) (string, error) {
	...
	repoFile := filepath.Join(primary, ".eredo", "allowlist.txt")
	...
	fmt.Fprintf(&out, "# generated by eredo for %s from:\n", name)
...
func cmdConfig(args []string) error {
	...
	case "show":
		...
		fmt.Println("              + <repo>/.eredo/allowlist.txt when present")
	default:
